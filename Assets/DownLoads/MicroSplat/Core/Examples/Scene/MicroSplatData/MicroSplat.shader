    ...
    void SurfaceFunction(inout Surface o, inout ShaderData d)
    {
        ...
        o.Alpha = l.Alpha;
         ...
         ShaderData CreateShaderData(VertexToPixel i)
         {
            ...
            float3 bitangent = cross(i.worldTangent.xyz, i.worldNormal) * i.worldTangent.w > 0 ? 1 : -1;
            

            d.TBNMatrix = float3x3(d.worldSpaceTangent, bitangent, d.worldSpaceNormal);
            d.worldSpaceViewDir = normalize(_WorldSpaceCameraPos - i.worldPos);
            d.tangentSpaceViewDir = mul(float3x3(i.worldTangent.xyz, cross(i.worldTangent.xyz, i.worldNormal), i.worldNormal), d.worldSpaceViewDir);
...
float3 GetTessFactors ()
{
   ...
   Dependency "BaseMapShader" =  "Hidden/MicroSplat/Example_Base943438555"
   Fallback "Hidden/MicroSplat/Example_Base943438555"
